...
BINARY_FEATURES = ["diabetes_0", "diabetes_1", "smoking", "last_preg_sga", "last_preg_fgr", "last_preg_normal", "prev_failed_preg", "high_risk_pe"]
MULTICLASS_FEATURES = ["af", "placenta_site"]
REGRESSION_FEATURES = ["bpd", "cpr", "ute_api", "psv", "ute_ari", "umb_api", "m_height", "m_weight"]
